...
XOR entre A y B te dice que bits son diferentes entre ellos. Como el XOR es acumulativo, simplemente hacemos un XOR
entre todo el array, y cada elemento que aparece dos veces se va a cancelar pues x ^ x = 0, dejando al final el unico
